...
public class CropImage extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        if (args.length < 2) {
            System.out.println("Usage: CropImage <input HIB> <output directory>");
            System.exit(0);
        }
    ...
    public static class ImageMapper extends Mapper<HipiImageHeader, FloatImage, IntWritable, FloatImage>{
        ...
        public void map(HipiImageHeader key, FloatImage value, Mapper.Context context) throws IOException, InterruptedException {
    ...
    public static class ImageReducer extends Reducer<IntWritable, FloatImage, IntWritable, Text>{
        ...
        public void reduce(IntWritable key, Iterable<FloatImage> values, Reducer.Context context) throws IOException, InterruptedException {
